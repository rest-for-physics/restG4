...
Int_t Validate(const char* filename) {
    ...
    const double averageTotalEnergyRef = (!isReferenceGeant4Version) ? 2457.00 : 2457.00;
    ...
    const double averageNumberOfHitsRef = (!isReferenceGeant4Version) ? 5535.16 : 361.33;
